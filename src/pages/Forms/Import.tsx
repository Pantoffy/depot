                          ...
                          .map((supplier: any) => (
                            <li key={supplier.id}>
                              <button
                                ...
                                className={`w-full px-4 py-2.5 text-left text-sm transition-colors ${selectedSupplierId === supplier.id ? "bg-gray-100 text-gray-900 dark:bg-gray-800 dark:text-white" : "text-gray-800 hover:bg-gray-50 dark:text-gray-100 dark:hover:bg-gray-800/50"}`}
                              >
